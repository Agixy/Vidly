...
namespace Vidly.Controllers
{
    public partial class MoviesController
    {
        ...
        public class ViewsClass
        {
            ...
            public readonly string Random = "~/Views/Movies/Random.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_MoviesController : Vidly.Controllers.MoviesController
    {
        public T4MVC_MoviesController() : base(Dummy.Instance) { }

        [NonAction]
        partial void RandomOverride(T4MVC_System_Web_Mvc_ActionResult callInfo);
